...
class ExcelMergerApp(ctk.CTk):
    ...
    def setup_second_frame(self):
        ...
        self.files_merge_btn.grid(row=3, column=0, columnspan=2, pady=20)
        self.files_progress_frame, self.files_progress_bar, self.files_status_label = self._create_progress_widgets(self.second_frame, row=4, columnspan=2)
